...
<ul class="dropdown-menu pull-right">
  ...
  <li style="border-top: 1px solid #444">
    <a href="https://github.com/amefs/quickbox-arm64/issues/new" target="_blank" rel="noopenner noreferrer"><i class="fa fa-warning text-warning"></i><?php echo T('ISSUE_REPORT_TXT'); ?></a>
  </li>
</ul>
